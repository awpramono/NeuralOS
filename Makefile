...
OBJS = src/boot.o src/trampoline.o src/vga.o src/memory.o src/ide.o src/math.o src/smp.o src/keyboard.o src/ai.o src/llama2.o src/agent.o src/vm.o src/serial.o src/fs.o src/neuralc.o src/kernel.o
